...
const Contact = ()=>{
    ...
    return(<div id="contact" className="contact container-landing">            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <form  onSubmit={handleSubmit(onSubmit)}  className="p-8 flex flex-col gap-5">
                    ...
                    { socialMedia.length > 0 &&  <div className="flex flex-wrap gap-2">
                        { socialMedia.map((e,idx)=>{
                            if(e.value != ""){
                                return (<div key={`Selected_Social_${e.name}_${idx}`}>
                                        {e.icon}
                                </div>)
                            }
                        }) }

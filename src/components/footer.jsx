    ...
    return(<footer >
        <div className="px-10 py-5">
            ...
            <div className="flex first-footer flex-col gap-5 ">
                ...
                <div className="flex gap-5 justify-center pages">
                    {pages.map((e,idx)=>(<Link to={e.link} key={`Pages_${e.name}_${idx}`} aria-label={e.name}><div >{e.name}</div></Link>))}
                </div>
            </div>
        </div>
